...
try {
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS ad_data_cache (
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS dashboard_config (
        id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS team_client_access (
        user_id INT UNSIGNED NOT NULL,
        client_id INT UNSIGNED NOT NULL,
